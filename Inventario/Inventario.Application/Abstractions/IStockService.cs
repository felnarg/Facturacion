...
public interface IStockService
{
    ...
    Task<StockDto?> IncreaseAsync(Guid productId, int quantity, Guid? referenceId = null, CancellationToken cancellationToken = default);
    Task<StockDto?> DecreaseAsync(Guid productId, int quantity, Guid? referenceId = null, CancellationToken cancellationToken = default);
